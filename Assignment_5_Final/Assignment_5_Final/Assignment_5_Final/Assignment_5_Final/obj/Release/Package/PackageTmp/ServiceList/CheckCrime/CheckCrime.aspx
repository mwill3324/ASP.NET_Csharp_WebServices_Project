<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CheckCrime.aspx.cs" Inherits="Assignment_5_Final.CheckCrime" %>
...
<body>
    ...
    <h1 style="text-align:center">CRIME</h1>
 ...
 <asp:Button ID="FindResButton" class="button button5" runat="server" Text="Find Resturants" OnClick ="Go_FindRes" />
   <p>Please click the button below to view the crime rate at the chosen zip code.</p>
        <p>
        <asp:Button ID="GetCrimeButton" runat="server" Text="Get Crime" OnClick="findCrime" />
    </p> 
    <p>
