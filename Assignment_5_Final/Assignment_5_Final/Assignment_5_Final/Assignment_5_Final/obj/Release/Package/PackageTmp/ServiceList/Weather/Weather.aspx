<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Weather.aspx.cs" Inherits="Assignment_5_Final.Weather" %>
...
<body>
 ...
 <asp:Button ID="FindResButton" class="button button5" runat="server" Text="Find Resturants" OnClick ="Go_FindRes" />
        ...
        <p>Please click the button below to view the current weather at the chosen zip code</p>


    <p>
        <asp:Button ID="weatherBtn" runat="server" Text="FIND Weather" OnClick="findWeather" />
    </p> 
    <p>
        <asp:BulletedList ID="rr" runat="server"></asp:BulletedList>
    </p>
            </div>
        </form>
</body>
