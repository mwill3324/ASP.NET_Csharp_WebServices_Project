<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Solar.aspx.cs" Inherits="Assignment_5_Final.Solar" %>
...
<body>
    ...
    <h1 style="text-align:center">Solar</h1>
 ...
 <asp:Button ID="FindResButton" class="button button5" runat="server" Text="Find Resturants" OnClick ="Go_FindRes" />
        ...
        <p>Please click the button below to view the average solar intensity at the chosen zip code</p>
        <p>
        <asp:Button ID="weatherBtn" runat="server" Text="SOLAR ME" OnClick="findSolar" />
    </p> 
    <p>
